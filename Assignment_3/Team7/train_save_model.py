...
ACCESS_KEY_ID = input("Please enter aws access key id: ")
ACCESS_SECRET_KEY = input("Please enter aws access secrete key: ")
...
model_chooser = input('Please enter one number represents above model: ')
