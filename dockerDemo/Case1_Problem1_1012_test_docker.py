...
logging.basicConfig(filename = "./LoggerTest.log",
                   level = logging.DEBUG,
                   format = LOG_FORMAT)
...
s3.upload_file('./csv_file.zip', bucket_name, 'csv_file.zip')
s3.upload_file('./LoggerTest.log', bucket_name, 'LoggerTest.log')
